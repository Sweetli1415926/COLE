    ...
    function ExtendedClass() {
      ...
      if (!proto2.$constructor) {
        if (!isESClass(superClass)) {
          ...
          var ins = createObject(
            ExtendedClass.prototype,
            new (superClass.bind.apply(superClass, __spreadArrays([void 0], args)))()
          );
          return ins;
        }
      } else {
...
function registerAction(actionInfo, eventName, action) {
  ...
  var actionType = isObject4(actionInfo) ? actionInfo.type : [actionInfo, actionInfo = {
    event: eventName
  }][0];
...
function normalizeRegister(targetList, priority, fn, defaultPriority, visualType) {
  if (isFunction2(priority) || isObject4(priority)) {
    fn = priority;
...
*/
//# sourceMappingURL=chunk-GWJS6VOE.js.map
