import {
  ...
  updateViewOnZoom,
  warnDeprecated
} from "./chunk-TVIFMFCE.js";
import {
  createDimensions,
  createListFromArray_default
} from "./chunk-I46ETXKA.js";
import {
  BezierCurve_default,
  Chart_default,
  Circle_default,
...
function avoidOverlap(labelLayoutList, cx, cy, r, viewWidth, viewHeight, viewLeft, viewTop) {
  ...
  for (var i = 0; i < labelLayoutList.length; i++) {
    ...
    if (linePoints) {
      ...
      var realTextWidth = layout2.rect.width;
      ...
      if (targetTextWidth < layout2.rect.width) {
        layout2.label.style.width = targetTextWidth;
...
var PiePiece = function(_super) {
  ...
  PiePiece2.prototype.updateData = function(data, idx, startAngle, firstCreate) {
    ...
    var sectorShape = extend(getSectorCornerRadius(itemModel.getModel("itemStyle"), layout2) || {}, layout2);
    ...
    if (graphSeries.get("layout") === "force") {
      ...
      forceInstance.beforeStep(function(nodes, edges2) {
        for (var i = 0, l = nodes.length; i < l; i++) {
          if (nodes[i].fixed) {
            copy2(nodes[i].p, graph_1.getNodeByIndex(i).getLayout());
          }
        }
      });
...
function calcOldElLocalTransformBasedOnNewElParent(oldEl, newEl) {
  ...
  oldGlobalTransform ? copy(tmpM, oldGlobalTransform) : identity(tmpM);
