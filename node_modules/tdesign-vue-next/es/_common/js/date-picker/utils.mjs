...
import { c as commonjsGlobal } from '../../../_chunks/dep-64900979.mjs';
import { t as toInteger_1, c as customParseFormat } from '../../../_chunks/dep-5901f702.mjs';
import { _ as _baseSlice } from '../../../_chunks/dep-e150d7bf.mjs';
...
function getWeeks(_ref4, _ref5) {
  ...
  for (i; i <= maxDays; i++) {
    ...
    daysArr.push({
      ...
      active: false,
      value: currentDay,
      disabled: isFunction_1(disableDate) && disableDate(currentDay) || outOfRanges(currentDay, minDate, maxDate),
  ...
  if (prependDay.getDay() !== firstDayOfWeek) {
    ...
    while (true) {
      daysArr.unshift({
        ...
        disabled: isFunction_1(disableDate) && disableDate(prependDay) || outOfRanges(prependDay, minDate, maxDate),
        additional: true,
        type: "prev-month",
  ...
  while (daysArr.length < LEN) {
    ...
    daysArr.push({
      ...
      disabled: isFunction_1(disableDate) && disableDate(appendDay) || outOfRanges(appendDay, minDate, maxDate),
      additional: true,
      type: "next-month",
...
function getQuarters(year, _ref6) {
  ...
  for (var i = 1; i <= 4; i++) {
    ...
    quarterArr.push({
      ...
      disabled: isFunction_1(disableDate) && disableDate(date) || outOfRanges(date, minDate, maxDate),
      active: false,
