...
import { i as isUndefined_1 } from '../../../_chunks/dep-9189b575.mjs';
...
function formatToNumber(num, extra) {
  ...
  if (!isUndefined_1(extra === null || extra === void 0 ? void 0 : extra.decimalPlaces)) {
    newNumber = largeNumberToFixed(newNumber, extra.decimalPlaces, extra.largeNumber);
  }
  var val = isLargeNumber || !isUndefined_1(extra === null || extra === void 0 ? void 0 : extra.decimalPlaces) ? newNumber : Number(newNumber);
...
function canInputNumber(number, largeNumber) {
  ...
  if (!number && isString_1(number)) return true;
