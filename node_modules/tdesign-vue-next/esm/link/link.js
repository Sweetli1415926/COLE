...
import '../_chunks/dep-67a6dabb.js';
import 'dayjs';
import '../_chunks/dep-772465a7.js';
...
var _Link = defineComponent({
  ...
  setup: function setup(props2, _ref) {
    ...
    var isDisabled = computed(function () {
      return props2.disabled || disabled.value;
    });
    var linkClass = computed(function () {
      var _ref2;
      return ["".concat(COMPONENT_NAME.value), "".concat(COMPONENT_NAME.value, "--theme-").concat(props2.theme), (_ref2 = {}, _defineProperty(_ref2, SIZE.value[props2.size], props2.size !== "medium"), _defineProperty(_ref2, STATUS.value.disabled, isDisabled.value), _defineProperty(_ref2, "".concat(classPrefix.value, "-is-underline"), props2.underline), _defineProperty(_ref2, "".concat(COMPONENT_NAME.value, "--hover-").concat(props2.hover), !isDisabled.value), _ref2)];
    });
