...
require('../_chunks/dep-909528c2.js');
  ...
  setup: function setup(props2) {
    ...
    return function () {
      ...
      var cls = vue.computed(function () {
        var _ref;
        return _ref = {}, _defineProperty__default["default"](_ref, componentName.value, true), _defineProperty__default["default"](_ref, "".concat(componentName.value, "--theme-").concat(theme), true), _defineProperty__default["default"](_ref, "".concat(componentName.value, "--").concat(shape), true), _defineProperty__default["default"](_ref, "".concat(componentName.value, "--show"), visible.value), _defineProperty__default["default"](_ref, "".concat(classPrefix.value, "-size-s"), size === "small"), _defineProperty__default["default"](_ref, "".concat(classPrefix.value, "-size-m"), size === "medium"), _ref;
      });
