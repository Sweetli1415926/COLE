...
var _DropdownItem = vue.defineComponent({
  ...
  setup: function setup(props) {
    ...
    return function () {
      ...
      var classes = [dropdownItemClass.value, "".concat(dropdownItemClass.value, "--theme-").concat(props.theme), (_ref = {}, _defineProperty__default["default"](_ref, "".concat(dropdownItemClass.value, "--active"), props.active), _defineProperty__default["default"](_ref, "".concat(dropdownItemClass.value, "--disabled"), props.disabled), _ref)];
