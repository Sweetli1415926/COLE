...
require('../../_chunks/dep-15bff572.js');
...
function useSingleValue(props) {
  ...
  var time = vue.ref(_common_js_datePicker_format.formatTime(value.value, formatRef.value.format, formatRef.value.timeFormat, props.defaultTime));
  var month = vue.ref(_common_js_datePicker_format.parseToDayjs(value.value, formatRef.value.format).month());
  var year = vue.ref(_common_js_datePicker_format.parseToDayjs(value.value, formatRef.value.format).year());
